...
window.addEventListener('DOMContentLoaded', event => {
    ...
    // Toggle the Dashboard sub-menu
    const dashboardToggle = $('#dashboardToggle');
    if (dashboardToggle) {
        if (localStorage.getItem('sb|dashboard-toggle') === 'true') {
            dashboardToggle.removeClass('collapsed');
            $('#collapseDashboards').addClass('show');
        }
        dashboardToggle.on('click', function (){
            localStorage.setItem('sb|dashboard-toggle', !$(this).hasClass('collapsed'));
        });
    }
