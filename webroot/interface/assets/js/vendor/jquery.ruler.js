  ...
  $.fn.ruler = function (options) {
    ...
    if (!Modernizr.touch) {
      ...
      if (settings.showCrosshair) {
        $(".jobfile-edit-img").append(vMouse, hMouse);
      }
      // Mouse position
      if (settings.showMousePos) {
        $(".jobfile-edit-img").append(mousePosBox);
      }
        ...
        $(window).mousemove(function (e) {
          ...
          if (settings.showMousePos) {
            $(".mousePosBox")
              .html(
                "x:" +
                  (e.pageX - settings.vRuleSize) +
                  ", y:" +
                  (e.pageY - settings.hRuleSize)
              )
              .css({
    ...
    $(window).resize(function (e) {
      ...
      while (tickLabelPos <= $hRule.width()) {
        if ((tickLabelPos - settings.vRuleSize) % 50 == 0) {
          newTickLabel =
            "<div class='tickLabel'>" +
            (tickLabelPos - settings.vRuleSize) +
            "</div>";
          $(newTickLabel)
    ...
    return this.each(function () {
      ...
      if (settings.vRuleSize > 0) {
        ...
        $this
          .css("padding-left", settings.vRuleSize + 1 + "px")
          .outerWidth(oldWidth);
        $(vRule)
