...
use Cake\Database\Schema\SchemaDialect as SchemaDialectAlias;
...
class DummyTest extends Driver
{
     ...
     */
    protected SchemaDialectAlias $_schemaDialect;
     ...
     * @inheritDoc
     */
    public function schemaDialect(): SchemaDialectAlias
    {
