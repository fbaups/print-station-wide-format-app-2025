...
class BuildTasks
{
    ...
    public function build($options = [])
    {
        ...
        $ignoreFilesFolders = [
            ...
            "src\\Controller\\ReleaseBuilderController.php",
            ...
            "src\\Controller\\FooRatingsController.php",
            ...
            "templates\\FooRatings\\add.php",
            "templates\\FooRatings\\edit.php",
            "templates\\FooRatings\\index.php",
            "templates\\FooRatings\\view.php",
