...
class AppTable extends Table
{
     ...
     * @return array|false
     */
    public function redactEntity(Entity|int|string $idOrEntity, array $toRedact = []): Entity
    {
     ...
     */
    public function getCurrentAuthenticatedUser(): bool|array|EntityInterface
    {
        $session = new Session();
...
//        file_put_contents(LOGS . "datatables-column-search.json", json_encode($datatablesQuery, JSON_PRETTY_PRINT));
    ...
    public function getSafeMimeTypes(): array
    {
        ...
        return array_merge($safe, $pdf, $image);
    }
     ...
     * @return false|string
     */
    public function getExtensionFromMimeType($mime): bool|string
    {
        $mime_map = [
            'video/3gpp2' => '3g2',
            'video/3gp' => '3gp',
