 ...
 */
class ProcessUStoreOrders extends WorkflowBase
{
    /**
     ...
     * @return Order[]
     */
    private function parseOrderXml($xmlPath): array
    {
        $uStore = new uStoreOrdering();
        $result = $uStore->loadOrder($xmlPath);
        $this->mergeAlerts($uStore->getAllAlertsForMerge());
