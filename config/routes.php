...
return static function (RouteBuilder $routes) {
    ...
    $routes->scope('/', function (RouteBuilder $builder) {
         ...
         * You have 2 options of where the base path goes.
         * 1) Contents requires $this->Auth()
         * 2) Pages are public facing
         * You must manually comment out 1 of the following 2 line
         */
        ...
        $builder->connect('/request/*', ['controller' => 'Users', 'action' => 'request']);
