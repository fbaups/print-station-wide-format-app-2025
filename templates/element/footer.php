        ...
        <div class="row">
            ...
            <div class="col">
                <div class="float-start small">
                    ...
                    &middot;
                    <?= $this->AuthUser->link(__("Privacy Policy"), ['controller' => 'Contents', 'action' => 'privacy-policy',]) ?>
                    &middot;
                    <?= $this->AuthUser->link(__("Terms & Conditions"), ['controller' => 'Contents', 'action' => 'terms-and-conditions',]) ?>
                </div>
