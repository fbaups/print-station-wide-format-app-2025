 ...
 * @var AppView $this
 * @var array $services
 * @var bool $areProtectionServicesRunning
 */
...
<div class="container-fluid px-4">
    ...
    <?php if ($this->AuthUser->hasRoles(['superadmin'])) { ?>
        <div class="card mb-5">
            <div class="card-header">
                <?= __('Configure Background Services') ?>
            </div>
            <div class="card-body">
                <div class="background-services index content">
                    <p>
                    ...
                    <?php if (1 === 2) { ?>
                        <p>
                            ...
                            ?>
                            Start all Background Services with a Current State of STOPPED or PAUSED and Startup Type is
                            not
                            DISABLED
                        </p>
                        <p>
...
<script>
    $(document).ready(function () {
        ...
        $('.background-service-manage').on('click', function () {
            ...
            var targetUrl = homeUrl + 'administrators/background-services/manage';
        ...
        function getServicesInfo() {
            var targetUrl = homeUrl + 'administrators/background-services/services-info';
            $.ajax({
                url: targetUrl,
                dataType: 'json',
