...
<?php foreach ($users as $k => $user): ?>
    ...
    if ($allowImpersonation) {
        $impersonateLinkText = " | " . $this->Form->postLink(__('Impersonate'), ['prefix' => 'Administrators', 'controller' => 'Users', 'action' => 'impersonate', $user->id], ['confirm' => __('Are you sure you want to impersonate {0} {1}?', $user->first_name, $user->last_name)]);
    }
