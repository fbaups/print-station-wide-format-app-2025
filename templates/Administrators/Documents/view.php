...
<div class="container-fluid px-4">
    <div class="card">
        ...
        <div class="card-header">
            <?= h($document->name) ?>
            <?= $this->Html->link('<i class="fas fa-edit"></i>' . __('&nbsp;Edit Document'), ['action' => 'edit', $document->id],
            ...
            <div class="documents view content">
                <div class="table-responsive">
                    <table class="table table-bordered table-sm">
                        ...
                        <tr>
                            <th><?= __('Job') ?></th>
                            <td><?= $document->has('job') ? $this->Html->link($document->job->name, ['controller' => 'Jobs', 'action' => 'view', $document->job->id]) : '' ?></td>
                        </tr>
                        <tr>
                            <th><?= __('Document Status') ?></th>
                            <td><?= $document->has('document_status') ? $this->Html->link($document->document_status->name, ['controller' => 'DocumentStatuses', 'action' => 'view', $document->document_status->id]) : '' ?></td>
                        </tr>
                        <tr>
                            <th><?= __('Name') ?></th>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($document->document_alerts as $documentAlerts) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'DocumentAlerts', 'action' => 'view', $documentAlerts->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'DocumentAlerts', 'action' => 'edit', $documentAlerts->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'DocumentAlerts', 'action' => 'delete', $documentAlerts->id], ['confirm' => __('Are you sure you want to delete # {0}?', $documentAlerts->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($document->document_properties as $documentProperties) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'DocumentProperties', 'action' => 'view', $documentProperties->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'DocumentProperties', 'action' => 'edit', $documentProperties->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'DocumentProperties', 'action' => 'delete', $documentProperties->id], ['confirm' => __('Are you sure you want to delete # {0}?', $documentProperties->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($document->document_status_movements as $documentStatusMovements) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'DocumentStatusMovements', 'action' => 'view', $documentStatusMovements->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'DocumentStatusMovements', 'action' => 'edit', $documentStatusMovements->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'DocumentStatusMovements', 'action' => 'delete', $documentStatusMovements->id], ['confirm' => __('Are you sure you want to delete # {0}?', $documentStatusMovements->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
