 ...
 * @var AppView $this
 * @var array $typeMap
 * @var Entity|MediaClip $recordData
 * @var Entity|Artifact $artifact
...
<div class="record-preview">
    <dl class="row mb-0">
        ...
        if (is_file($artifact->sample_unc_preview)) {
            ...
            } elseif (in_array($artifact->mime_type, $imageMimeTypes)) {
                $mediaTypeText = 'Image Preview';
            } elseif (in_array($artifact->mime_type, $videoMimeTypes)) {
