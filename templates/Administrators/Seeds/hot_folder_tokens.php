...
<?php foreach ($seeds as $seed): ?>
    ...
    $rows[$counter][] =
        $this->Form->postLink(__('Delete'), ['action' => 'hot-folder-token-delete', $seed->token], ['confirm' => __('Are you sure you want to delete Token {0}?', $seed->token)]);
    ?>
    <?php $counter++ ?>
<?php endforeach; ?>
<?php
    ...
    <div class="card mb-5">
        ...
        <div class="card-body">
            <div class="hot-folder-tokes index content">
                <p>
                    <?php
                    $fullSubmitUrl = Router::url(['prefix' => false, 'controller' => 'HotFolders', 'action' => 'submit', 'hot_folder_name'], true);
                    ?>
...
<div class="container-fluid px-4">
    <div class="card">
        ...
        <div class="card-header">
            ...
            <?= $this->Form->postLink('<i class="fas fa-plus"></i>' . __('&nbsp;New Token'), ['action' => 'hot-folder-token-add'],
