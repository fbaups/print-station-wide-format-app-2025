...
<div class="container-fluid px-4">
    <div class="card">
        ...
        <div class="card-header">
            <?= h($user->id) ?>
            <?= $this->Html->link('<i class="fas fa-edit"></i>' . __('&nbsp;Edit User'), ['action' => 'edit', $user->id],
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($user->user_localizations as $userLocalizations) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'UserLocalizations', 'action' => 'view', $userLocalizations->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'UserLocalizations', 'action' => 'edit', $userLocalizations->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'UserLocalizations', 'action' => 'delete', $userLocalizations->id], ['confirm' => __('Are you sure you want to delete # {0}?', $userLocalizations->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
