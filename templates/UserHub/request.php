...
$this->assign('title', 'Request Invitation');
$this->set('headerShow', true);
$this->set('headerIcon', __(""));
$this->set('headerTitle', __(APP_NAME . ' Request Invitation'));
            ...
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                <div class="card-header justify-content-center">
                    ...
                    if (empty(APP_LOGO)) {
                        ...
                        <h3 class="fw-light my-4 text-center">
                            <?= APP_NAME ?><br>Request Invitation
                        </h3>
                        <?php
                    } else {
                        ?>
                ...
                <div class="card-body">
                    ...
                    $options = [
                        ...
                        'required' => 'required',
                        'templateVars' => ['wrapperClass' => 'wrapper-username d-none'],
                    ];
                    ...
                    $options = [
                        ...
                        'placeholder' => 'Email',
                        'required' => 'required',
                        'templateVars' => ['wrapperClass' => 'wrapper-email'],
                    ];
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                        ...
                        <?= $this->Form->submit('Request Invitation', $submitOptions) ?>
                    </div>
