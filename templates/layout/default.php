...
<?php echo $this->element('mode-banner', options: ['ignoreMissing' => true]); ?>
<?php echo $this->element('navbar', options: ['ignoreMissing' => true]); ?>
<div id="layoutSidenav">

    <?php echo $this->element('sidenav', options: ['ignoreMissing' => true]); ?>
    ...
    <div id="layoutSidenav_content">
        ...
        <?php echo $this->element('footer', options: ['ignoreMissing' => true]); ?>
    </div>
</div>
