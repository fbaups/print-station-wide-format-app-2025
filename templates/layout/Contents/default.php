...
<?php echo $this->element('Contents/navbar', options: ['ignoreMissing' => true]); ?>
<div id="layoutSidenav">

    <?php echo $this->element('Contents/sidenav', options: ['ignoreMissing' => true]); ?>
    ...
    <div id="layoutSidenav_content">
        ...
        <?php echo $this->element('Contents/footer', options: ['ignoreMissing' => true]); ?>
    </div>
</div>
