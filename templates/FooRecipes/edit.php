 ...
 * @var string[]|\Cake\Collection\CollectionInterface $fooAuthors
 * @var string[]|\Cake\Collection\CollectionInterface $fooTags
 */

$this->set('headerShow', true);
$this->set('headerIcon', __(""));
$this->set('headerTitle', __('Edit Foo Recipe'));
