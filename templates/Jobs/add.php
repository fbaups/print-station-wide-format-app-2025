 ...
 * @var AppView $this
 * @var Job $job
 * @var CollectionInterface|string[] $orders
 * @var CollectionInterface|string[] $jobStatuses
...
$this->set('headerTitle', __('Add Job'));
        ...
        <div class="card-body">
            <div class="jobs form content">
                ...
                <fieldset>
                    ...
                    echo $this->Form->control('order_id', $opts);
                    ...
                    echo $this->Form->control('external_job_number', $opts);
