...
<div class="container-fluid px-4">
    <div class="card">
        ...
        <div class="card-header">
            <?= h($job->name) ?>
            <?= $this->Html->link('<i class="fas fa-edit"></i>' . __('&nbsp;Edit Job'), ['action' => 'edit', $job->id],
            ...
            <div class="jobs view content">
                <div class="table-responsive">
                    <table class="table table-bordered table-sm">
                        ...
                        <tr>
                            <th><?= __('Order') ?></th>
                            <td><?= $job->has('order') ? $this->Html->link($job->order->name, ['controller' => 'Orders', 'action' => 'view', $job->order->id]) : '' ?></td>
                        </tr>
                        <tr>
                            <th><?= __('Job Status') ?></th>
                            <td><?= $job->has('job_status') ? $this->Html->link($job->job_status->name, ['controller' => 'JobStatuses', 'action' => 'view', $job->job_status->id]) : '' ?></td>
                        </tr>
                        <tr>
                            <th><?= __('Name') ?></th>
                            <td><?= h($job->name) ?></td>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($job->job_alerts as $jobAlerts) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'JobAlerts', 'action' => 'view', $jobAlerts->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'JobAlerts', 'action' => 'edit', $jobAlerts->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'JobAlerts', 'action' => 'delete', $jobAlerts->id], ['confirm' => __('Are you sure you want to delete # {0}?', $jobAlerts->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($job->job_properties as $jobProperties) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'JobProperties', 'action' => 'view', $jobProperties->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'JobProperties', 'action' => 'edit', $jobProperties->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'JobProperties', 'action' => 'delete', $jobProperties->id], ['confirm' => __('Are you sure you want to delete # {0}?', $jobProperties->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($job->job_status_movements as $jobStatusMovements) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'JobStatusMovements', 'action' => 'view', $jobStatusMovements->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'JobStatusMovements', 'action' => 'edit', $jobStatusMovements->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'JobStatusMovements', 'action' => 'delete', $jobStatusMovements->id], ['confirm' => __('Are you sure you want to delete # {0}?', $jobStatusMovements->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
