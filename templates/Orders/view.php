...
<div class="container-fluid px-4">
    <div class="card">
        ...
        <div class="card-header">
            <?= h($order->name) ?>
            <?= $this->Html->link('<i class="fas fa-edit"></i>' . __('&nbsp;Edit Order'), ['action' => 'edit', $order->id],
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($order->order_alerts as $orderAlerts) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'OrderAlerts', 'action' => 'view', $orderAlerts->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'OrderAlerts', 'action' => 'edit', $orderAlerts->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'OrderAlerts', 'action' => 'delete', $orderAlerts->id], ['confirm' => __('Are you sure you want to delete # {0}?', $orderAlerts->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($order->order_properties as $orderProperties) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'OrderProperties', 'action' => 'view', $orderProperties->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'OrderProperties', 'action' => 'edit', $orderProperties->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'OrderProperties', 'action' => 'delete', $orderProperties->id], ['confirm' => __('Are you sure you want to delete # {0}?', $orderProperties->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
                        ...
                        <table class="table table-bordered table-sm">
                            ...
                            <?php foreach ($order->order_status_movements as $orderStatusMovements) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(__('View'), ['controller' => 'OrderStatusMovements', 'action' => 'view', $orderStatusMovements->id]) ?>
                                        <?= $this->Html->link(__('Edit'), ['controller' => 'OrderStatusMovements', 'action' => 'edit', $orderStatusMovements->id]) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['controller' => 'OrderStatusMovements', 'action' => 'delete', $orderStatusMovements->id], ['confirm' => __('Are you sure you want to delete # {0}?', $orderStatusMovements->id)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
