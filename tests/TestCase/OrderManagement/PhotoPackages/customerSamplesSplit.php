...
//    'n' => 'W:\arajcany_Projects\PhotoPackageAdapter\CustomerSamples\NTO\RIP12870.nto',
    ...
    'o' => CUSTOMER_SAMPLES . 'FCIM_Pic_Pro_2\Hazel_4782.TXT',
];
...
//
//    $masterFormats = $mf->splitMasterFormatIntoSingleImagesExpandingQuantity();
//
//    foreach ($masterFormats as $masterFormat) {
//        $oid = $masterFormat->getOrder_ID();
//
//        dump($masterFormat);
//
//    }
